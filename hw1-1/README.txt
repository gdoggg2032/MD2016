...
you have to install: numpy, python(2.7), nltk(3.0)
...
execute:
	...
	python decoder.py [bigramFile] [encodeProbFile] [encodedTextFile]
	...
	example:
		...
		python decoder.py ./bigram.txt ./encode.txt ./test.txt
